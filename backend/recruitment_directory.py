...
PERSONAL_MONITOR_POOLS = [
    ...
    },
    {
        ...
        "employers": [
            "中国移动", "中移九天", "中国移动通信研究院", "中国移动数智事业部",
            "中国电信", "中国联通", "中国铁塔", "中国电子", "中国电科",
...
EMPLOYER_ALIAS_GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "中芯国际": ("SMIC",),
    "B站": ("哔哩哔哩", "Bilibili"),
    # Foreign employers use one English-Chinese display identity everywhere:
    # the personal application ledger and the sector navigation share these
    # exact labels while retaining only true brand/legal aliases.
    "Deloitte 德勤": ("德勤", "Deloitte"),
    "PwC 普华永道": ("普华永道", "PwC", "PricewaterhouseCoopers"),
    "EY 安永": ("安永", "EY", "Ernst & Young"),
    "KPMG 毕马威": ("毕马威", "KPMG"),
    "Bain 贝恩": ("贝恩", "Bain", "Bain & Company"),
    "Kearney 科尔尼": ("科尔尼", "Kearney"),
    ...
    "中国移动": ("中国移动通信集团", "中国移动通信集团有限公司", "China Mobile"),
    "中移九天": (
        "中移九天人工智能科技（北京）有限公司", "中移九天人工智能科技有限公司",
        "中国移动九天人工智能科技公司", "九天人工智能研究院", "九天研究院",
    ),
    "中国移动通信研究院": (
        "中国移动研究院", "中国移动通信研究院有限公司", "China Mobile Research Institute",
    ),
    "中国移动数智事业部": (
        "中国移动数智事业部", "中移数智事业部", "中国移动数智业务部",
    ),
    "中国电信": ("中国电信集团", "中国电信集团有限公司", "China Telecom"),
    "中国联通": (
        "中国联合网络通信集团", "中国联合网络通信集团有限公司",
        "中国联合网络通信", "China Unicom",
    ),
    ...
    "中国电建": ("中国电力建设集团",),
    "中国电子": ("中国电子信息产业集团",),
    "中国人保": ("中国人民保险集团", "中国人民保险集团股份有限公司", "PICC"),
